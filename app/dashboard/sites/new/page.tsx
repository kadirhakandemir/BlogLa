...
export default function NewSiteRoute() {
    ...
    return (
        <div className="flex flex-col flex-1 items-center justify-center">
            <Card className="max-w-[450x]">
                <CardHeader>
                    <CardTitle>Create Site</CardTitle>
                    <CardDescription>Create your new Site here. Click the button below to get started.</CardDescription>
                </CardHeader>
                    ...
                    <CardContent>
                        <div className="flex flex-col gap-y-6">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Textarea name={fields.description.name} key={fields.description.key} defaultValue={fields.description.initialValue} placeholder="Small description for your Site" />
